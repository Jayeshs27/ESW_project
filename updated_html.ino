...
<!DOCTYPE HTML><html><head>
  ...
  <h1>Welcome to Team Quadcore's RPM tester!</h1>
    <pre class="input">Enter the desired RPM for the motor</pre>
    <br>
  <form action="/get">
    ...
    <input type="text" name="input1" class="input-is" placeholder="Enter RPM">
